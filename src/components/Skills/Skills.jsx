        ...
        <div className="container px-5 py-14 mx-auto">
          <div className="text-center mb-20" data-aos="fade-up">
            <h1
              ...
              <span
                style={{
                  background: "linear-gradient(to right, #f97316, #f59e9b)",
            ...
            <p
              ...
              Strategic problem-solving, technical innovation, collaborative
              design, adaptive learning, and execution.
            </p>
          </div>
          <div
            ...
            {skills.map((skill, index) => (
              <div
                ...
                <div
                  ...
                  hover:-translate-y-2 group hover:shadow-[0_0_30px_rgb(255,165,0,0.15)]">
