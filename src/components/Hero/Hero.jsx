...
const Hero = ({ darkMode }) => {
  ...
  const darkTheme = {
    ...
    buttonSecondary:
      "text-white border-2 border-yellow-500 hover:bg-yellow-600",
  ...
  const lightTheme = {
    ...
    buttonSecondary:
      "text-gray-800 border-2 border-yellow-500 hover:bg-yellow-500 hover:text-white",
        ...
        <div className="container mx-auto flex px-4 sm:px-8 lg:px-14 py-12 lg:py-14 flex-col lg:flex-row items-center justify-between lg:mt-14 mt-14">
          <div className="lg:w-1/2 w-full flex flex-col items-center lg:items-start text-center lg:text-left mb-12 lg:mb-0">
            ...
            <p
              ...
              data-aos="fade-up"
              data-aos-detay="600">
              I am a dedicated problem-solver and creative thinker focused on
              building impactful solutions that bridge the gap between complex
              ideas and user-centric design. With a background rooted in both
              technical precision and creative exploration, I strive to create
              work that is as functional as it is engaging.
            </p>
            {/* Button */}
            <div className="w-full pt-4 sm:pt-6">
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-3 sm:gap-4">
                <a href={CV} download className="w-full sm:w-auto">
                  <button className="w-full sm:w-auto inline-flex items-center justify-center text-white bg-linear-to-r from-yellow-400 to-amber-400 border-0 py-3 px-6 sm:px-8 hover:shadow-[0_0_40px_rgb(255,165,0,0.7)] rounded-full text-base sm:text-lg font-semibold transition-all duration-300 transform">
          ...
          <div
            ...
            <div className="relative w-4/5 sm:w-3/4 lg:w-full">
              ...
              <img
                src={hi}
                alt="Hi Icon"
                className="absolute -top-2 sm:top-4 left-8 sm:left-20 w-20 h-20 sm:w-25 sm:h-25 object-contain animate-bounce opacity-90 z-10"
              />
            </div>
          </div>
        </div>
        <div
          className={`absolute -top-20 -left-20 w-40 h-40 sm:w-64 sm:h-64 ${theme.decorativeCircle} rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-pulse delay-1000 hidden sm:block`}></div>
      </section>
    </div>
  );
};
